...
4. Изменить ssh-ключ в файле cloud-init.yml (ssh-keygen -t ed25519); (ssh-keygen -y -f — команда, которая извлекает публичный ключ из приватного). cp .terraformrc ~/.terraformrc
